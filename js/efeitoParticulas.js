const RADIUS = 4;const COLOR = "#FFF";
const TTL = 70; // 60f = 1s pra maioria dos monitores
const ACC = 0.5; // Gravidade em px/frame^2
const EFEITO = "Chuva";
const SENTIDO = Math.PI / 2;

const PERMANENCIA = 20;
